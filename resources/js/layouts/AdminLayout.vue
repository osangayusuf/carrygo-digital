    ...
    <div class="min-h-screen bg-background text-on-surface flex flex-col font-sans antialiased">
        ...
        <header
            ...
            <div class="flex items-center gap-2">
                <span class="text-primary font-black tracking-tight text-sm uppercase">BIDORA ADMIN</span>
            </div>
        ...
        <div class="flex flex-1 relative min-h-screen lg:min-h-0">
            ...
            <aside :class="[
                ...
                <div class="hidden lg:flex flex-col p-6 border-b border-outline-variant">
                    <h1 class="text-xl font-black text-primary tracking-tight uppercase">BIDORA ADMIN</h1>
                    <p class="text-[9px] font-bold text-on-surface-variant uppercase tracking-widest mt-1">Management
                        Suite</p>
                </div>
