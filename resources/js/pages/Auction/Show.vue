    ...
    <div class="mx-auto max-w-7xl px-4 py-8">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
            <div class="flex flex-col gap-6 lg:col-span-2">
                ...
                <section class="mt-6 rounded-xl border-2 border-sage-border bg-white p-4 sm:p-6">
                    <h2 class="mb-6 font-headline text-lg font-extrabold text-ink flex items-center gap-2">
                        <span class="material-symbols-outlined text-forest">rate_review</span>
                        Feedback & Reviews
                    </h2>
                    ...
                    <div v-if="userReviewState.canReview" class="mb-8 rounded-xl border border-sage-border bg-sage-bg/25 p-4 sm:p-5">
                        ...
                        <form @submit.prevent="submitReview" class="space-y-4">
                            <div>
                                ...
                                <p v-if="reviewForm.errors.rating" class="mt-1 text-xs font-bold text-error">
                            ...
                            <div v-if="userReviewState.isWinner" class="border-t border-sage-border pt-4 space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <p v-if="reviewForm.errors.photos" class="mt-1 text-xs font-bold text-error">
                                    ...
                                    <div>
                                        ...
                                        <p v-if="reviewForm.errors.video" class="mt-1 text-xs font-bold text-error">
