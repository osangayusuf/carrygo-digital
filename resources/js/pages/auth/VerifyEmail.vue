    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface px-6 py-12">
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <div
                ...
                <!-- Icon -->
                <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-forest/10">
                    <span class="pi pi-envelope text-3xl text-forest"></span>
                </div>

                <h1 class="mb-2 font-condensed text-3xl font-black tracking-tight text-ink">
                    Verify your email
                </h1>
                ...
                <Form :action="send.url()" method="post" v-slot="{ processing }">
