...
<template>
    ...
    <Head title="Agent Login - Bidora Support" />
    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface px-6 py-12">
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <div
                ...
                <!-- Status message -->
                <div v-if="status"
                    class="mb-6 rounded-lg border border-secondary/20 bg-secondary-container/40 px-4 py-3 text-center text-sm font-medium text-on-secondary-container">
                    {{ status }}
                </div>
                ...
                <Form :action="loginStore.url()" method="post" :reset-on-success="['password']"
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label for="remember" class="cursor-pointer text-sm text-on-surface-variant">Remember
                                me</label>
                        </div>
