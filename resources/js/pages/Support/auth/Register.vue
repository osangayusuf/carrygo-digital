...
<template>
    ...
    <Head title="Agent Registration - Bidora Support" />
    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-y-auto bg-surface px-6 py-12">
        ...
        <div class="pointer-events-none absolute inset-0">
            ...
            <div class="absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-forest/20 blur-[100px]" />
        </div>

        <div class="relative z-10 my-8 w-full max-w-lg">
            <!-- Logo / Brand -->
            <div class="mb-8 flex flex-col items-center justify-center">
                <Link :href="home.url()">
                    <img :src="`${$page.props.asset_url}logo.png`" alt="Bidora" class="mb-2 h-12 w-auto" />
                </Link>
                <span
            ...
            <div
                ...
                <Form :action="registerStore.url()" method="post"
                    :reset-on-success="['password', 'password_confirmation']" v-slot="{ errors, processing }">
                    <div class="space-y-5">
                        <!-- Name -->
                        <div class="space-y-1.5">
                            <label for="name"
                                class="ml-0.5 block text-xs font-bold tracking-widest text-on-surface-variant uppercase">
                                Full Name
                            </label>
                            ...
                            <p v-if="errors.name" class="mt-1 text-xs font-medium text-error">
                                {{ errors.name }}
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email" required
                                    class="block w-full rounded-lg border-none bg-surface-container-low px-5 py-3.5 text-sm text-on-surface shadow-sm transition-all placeholder:text-outline/50 focus:ring-2 focus:ring-secondary/40 focus:outline-none"
                                    placeholder="you@bidora.com" />
                                <p v-if="errors.email" class="mt-1 text-xs font-medium text-error">
                                    {{ errors.email }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <p v-if="errors.phone" class="mt-1 text-xs font-medium text-error">
                                    {{ errors.phone }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <p v-if="errors.department" class="mt-1 text-xs font-medium text-error">
                                    {{ errors.department }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <p v-if="errors.employee_id" class="mt-1 text-xs font-medium text-error">
                                    {{ errors.employee_id }}
                                </p>
                            </div>
                        </div>
                        ...
                        <button type="submit" :disabled="processing"
                            class="mt-4 flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-navy px-4 py-3.5 text-sm font-extrabold text-lemon shadow-lg shadow-navy/20 transition-all hover:bg-forest active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60">
