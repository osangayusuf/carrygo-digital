...
const shareMessage = computed(() => {
    return props.message || `I am bidding for this ${props.name}. Join me to bid on bidora`;
});
        ...
        <div v-if="props.isOpen"
            ...
            <div
                ...
                <p class="mb-6 text-sm text-outline">
                    Invite your friends to join the bid on <span class="font-bold text-on-surface">{{ props.name
                        }}</span>
                </p>
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <a :href="xUrl" target="_blank" rel="noopener noreferrer"
                        ...
                        <svg class="h-6 w-6 fill-current mb-1.5 group-hover:scale-110 transition-transform text-on-surface"
                            viewBox="0 0 24 24">
                            <path
                ...
                <div v-if="showFacebookTip"
                    class="mb-6 p-3.5 rounded-2xl bg-blue-600/10 border border-blue-500/20 flex items-start gap-2.5 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-blue-800/80 leading-tight">Facebook does not allow apps to pre-fill
                            post text. You can paste the copied text directly into your Facebook post.</p>
                    </div>
                </div>

                <!-- Copy Link Section -->
                <div class="border-t border-surface-container pt-4">
                    <label class="block text-xs font-bold tracking-widest text-outline uppercase mb-2">Copy
                        Auto-Generated Invite</label>
                    <div
                        class="flex items-center gap-2 bg-surface-container-low p-2.5 rounded-2xl border border-surface-container">
