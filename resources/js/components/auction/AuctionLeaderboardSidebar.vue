...
<template>
    <aside
        class="flex flex-col rounded-xl border-2 border-sage-border bg-white lg:sticky lg:top-24"
    >
        <header class="border-b-2 border-sage-border px-4 py-3">
            <h2
                class="text-xs font-black tracking-widest text-muted-green uppercase"
            >
                Top Bidders
            </h2>
            <p class="mt-0.5 text-[10px] font-semibold text-muted-green/80">
                By cumulative points bid
            </p>
        </header>
        ...
        <div class="flex flex-1 flex-col p-3">
            <div
                ...
                class="flex max-h-[min(70vh,32rem)] flex-col gap-1.5 overflow-y-auto"
            >
                <div
            ...
            <div
                v-else
                class="rounded-xl border border-dashed border-sage-border p-6 text-center"
            >
                <p class="text-xs font-bold text-muted-green">
                    No bids recorded
                </p>
                <p class="mt-1 text-[10px] text-muted-green/80">
