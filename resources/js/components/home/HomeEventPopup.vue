    ...
    <Transition name="popup">
        <div v-if="isVisible" class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog"
            ...
            <div
                ...
                <div
                    class="relative flex max-md:w-full w-2/5 shrink-0 items-center justify-center bg-surface-container p-8 pt-10">
                    ...
                    <div
                        ...
                        <div v-else class="flex h-56 w-full items-center justify-center">
                            <span class="material-symbols-outlined text-6xl text-secondary">stars</span>
                        </div>
                    </div>
                </div>
